...
def build_scanner(
    ...
    providers = DataProviderManager({"oanda": oanda}, logger=logger)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Scan OANDA and optional MT5 confirmed 1H engulfing signals")
